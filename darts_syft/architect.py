...
class Architect():
    ...
    def virtual_step(self, trn_X, trn_y, xi, w_optim):
        ...
        # compute gradient
        gradients = torch.autograd.grad(loss.get(), self.net.weights().copy().get()).send(trn_X.location)
    ...
    def unrolled_backward(self, model, trn_X, trn_y, val_X, val_y, xi, w_optim):
